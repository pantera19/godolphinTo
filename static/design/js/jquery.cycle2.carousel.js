...
$( document ).on('cycle-bootstrap', function( e, opts, API ) {
    ...
    API.customGetImageSrc = function( slideOpts, opts, slideEl ) {
        return $( slideEl ).attr('data-thumb-img');
    };

    API.customGetImageSrcWidth = function( slideOpts, opts, slideEl ) {
        return $( slideEl ).attr('data-thumb-img-w');
    };
    ...
    transition: function( opts, curr, next, fwd, callback ) {
        ...
        if ( opts.allowWrap === false ) {
	        ...
	        if ( dest >= opts.slideCount || dest < 0) {
                //curSlide = opts.slideCount-1;
		        callback = this.genCallback( opts, fwd, vert, callback );
	        }
	        moveBy = this.getScroll( opts, vert, opts.currSlide, hops );

            //var slideWidth = opts.container.width() / 2 - $(opts._carouselWrap.children()[curSlide]).outerWidth(true) / 2 - parseFloat($(opts._carouselWrap.children()[curSlide]).css('marginLeft'));
            //$('.slide-page div').css('width',slideWidth);
        }
